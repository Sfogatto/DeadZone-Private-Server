...
Welcome to the private server project for _The Last Stand: Dead Zone_. This project allows fans to relive this iconic game in a private setting.

---

## 📖 About the Game

_The Last Stand: Dead Zone_ is a game developed by Chris "Con" Condon, the founder of Con Artist Games. It blends RPG, action, and strategy elements in a post-apocalyptic world overrun by zombies. This game remains a cherished title among fans of the genre and the series.
...
We extend our sincere thanks to Chris "Con" Condon and Con Artist Games for their exceptional work on _The Last Stand: Dead Zone_ and other games in the series. Their dedication and creativity have made a lasting impact on fans worldwide.

---

## ☕ Support the Project

If you appreciate our work on _The Last Stand: Dead Zone - Private Server_ and want to support further development, you can now do so via **Buy Me a Coffee**! Your contributions help keep this project alive and improve its quality.
...
2. Double-click `run.bat` or run it via Command Prompt.  
   ...
   - Launch 4 servers:`file_server/main.py`, `socket_server.py`, `api_server.py` and `workaround.py`
...
- File server. Serve frontend and other necessary files.
- Api server. Handle protobuf request from the game.
- Socket server. Not so shure but handle realtime logics.
- Workaround. Create some workaround of links and files that the game need but couldn't be served from port 8000
